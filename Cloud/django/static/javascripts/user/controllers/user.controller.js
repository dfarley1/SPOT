(function () {
    ...
    function UserController($location, $scope, $http, User) {
        ...
        function get_spot() {
            $http.get('/api/v1/home/get_spot/',).then(get_spot_OK, get_spot_ERR);
        ...
        function get_status() {
            $http.get('/api/v1/home/get_status/',).then(get_status_OK, get_status_ERR);
        ...
        function get_events() {
            $http.get('/api/v1/home/get_events/',).then(get_OK, get_ERR);
